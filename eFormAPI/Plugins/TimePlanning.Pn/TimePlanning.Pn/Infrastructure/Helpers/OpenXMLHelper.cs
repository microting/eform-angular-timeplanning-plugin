...
public static class OpenXMLHelper
{
    ...
    public static void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
    {
    ...
    public static void GenerateThemePart1Content(ThemePart themePart1)
    {
        ...
        A.LatinFont latinFont2 = new A.LatinFont(){ Typeface = "Aptos Narrow", Panose = "02110004020202020204" };
        ...
        lineDefault1.Append(shapeProperties1);
