...
public class DataLonFileExporter : IPayrollExporter
{
    public PayrollSystemType SystemType => PayrollSystemType.DataLon;
    ...
    public Task<PayrollExportResult> Export(PayrollExportModel model)
    {
        ...
        var fileName = $"DataLon_Export_{model.PeriodStart:yyyyMMdd}_{model.PeriodEnd:yyyyMMdd}.csv";
