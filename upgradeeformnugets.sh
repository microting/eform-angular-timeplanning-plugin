...
if (( "$GIT_STATUS" > 0 )); then
  ...
  CURRENT_NUMBER_OF_COMMITS=`git log --oneline | wc -l`
	...
	PACKAGES=('Microting.eForm' 'Microting.eFormApi.BasePn' 'Microting.TimePlanningBase' 'Microting.EformAngularFrontendBase' 'Google.Apis.Sheets.v4' 'Sentry')
	...
	PROJECT_NAME='TimePlanning.Pn.Test.csproj'
	REPOSITORY='eform-angular-timeplanning-plugin'
